...
public enum SRP6StandardGroups {
    private static func fromHex(_ hex: String) -> BigInt {
        ...
        return BigInt(cleanedHex, radix: 16)!
    }
    
    private static func fromNG(_ hexN: String, _ hexG: String) -> SRP6GroupParameters {
        return SRP6GroupParameters(N: fromHex(hexN), G: fromHex(hexG))
    }
    
    /*
     * RFC 5054 standard groups
     */
    private static let RFC5054_1024_N = """
